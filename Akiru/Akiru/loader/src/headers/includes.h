...
#define TOKEN_QUERY     "/bin/busybox Ekiru"
#define TOKEN_RESPONSE  "Ekiru: applet not found"

#define EXEC_QUERY     "/bin/busybox ikiru"
#define EXEC_RESPONSE  "ikiru: applet not found"

#define FN_DROPPER  "Akaru32"
#define FN_BINARY   "Akiru32"
